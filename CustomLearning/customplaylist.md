...
A playlist is a compilation of "assets". An "asset" is a SharePoint page or existing item of Microsoft training content. When you create a playlist you select assets that go together to create a learning path for your user.  
...
- **Sub Category** - Preselected based on your initial selection
...
Your playlist with this content will now be available anywhere you have installed / embedded the Custom Learning web part. 
...
1. Navigate to any playlist within the web part or site experience
