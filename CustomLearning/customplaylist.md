...
![Screen where you select Custom Learning Administration.](media/custom_admin.png)
...
![Window with the Category option and the Plus sign highlighted.](media/custom_addplay.png)

1. Fill in the values as shown in the example below and select **Create**. 
![Page where you enter playlist details.](media/custom_details.png)
...
![Choose an image window.](media/custom_image.png)
...
1. **Enter in any search term** to see a list of predefined assets that are available from other playlists. **Click on the name** of an asset to include it in your new playlist.<br/>
![Playlist assets page](media/custom_slist.png)
...
![Form where you enter your title and additional details.](media/custom_newpage.png)
...
![Screen where you click Copy next to the URL.](media/share.png)
